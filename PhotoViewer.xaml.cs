...
namespace PhotoViewerDemo
{
    ...
    //brief: Interaction logic for PhotoViewer.xaml
    //Seperate window to view single selected image
    public partial class PhotoViewer : Window
    {
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            ViewedCaptionWidth.Content = SelectedPhoto.PhotoWidth;
            ViewedCaptionHeight.Content = SelectedPhoto.PhotoHeight;
        }
